...
<!--
FOTO PERSONALE (facoltativa, disattivata di default).
Il mio consiglio resta lo stesso: l'avatar del tuo account GitHub (Settings ->
Public profile -> upload a photo) appare già sopra questo README su ogni tua
pagina di profilo, quindi una seconda foto qui è spesso ridondante. Se vuoi
comunque aggiungerla per uno stile ancora più ricco, rimuovi i delimitatori
di commento e carica l'immagine nel repository (es. assets/foto.jpg):
...
![Teoria dei Sistemi](https://img.shields.io/badge/Teoria%20dei%20Sistemi-1e293b?style=for-the-badge)
![Controllo Automatico](https://img.shields.io/badge/Controllo%20Automatico-1e293b?style=for-the-badge)
